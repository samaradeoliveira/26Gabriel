...
var canvas, angle, tower, towerImage, ground, cannon;

//matrizes para balas e barcos
var balls = [];
var boats = [];

//função de carregamento de imagens em variáveis
function preload() {
...
function showCannonBalls(ball, index) {
  if (ball) {
    ball.display();
    //verificar se o corpo da bala está no mar(altura da tela), se sim, chamar remove
